//
// os/sdl/SDL_gamecontrollerdb.h: SDL gamecontroller database.
//
// CEN64: Cycle-Accurate Nintendo 64 Emulator.
// Copyright (C) 2015, Tyler J. Stachecki.
//
// This is part of SDL, but not every vendor ships a complete package so this file was copied from:
// https://hg.libsdl.org/SDL/raw-file/tip/src/joystick/SDL_gamecontrollerdb.h
// This file is subject to the terms and conditions defined in the block below.
...
static const char *s_ControllerMappings [] =
    ...
    "030000005e040000ea02000000000000,Xbox One Wired Controller,a:b0,b:b1,back:b9,dpdown:b12,dpleft:b13,dpright:b14,dpup:b11,guide:b10,leftshoulder:b4,leftstick:b6,lefttrigger:a2,leftx:a0,lefty:a1,rightshoulder:b5,rightstick:b7,righttrigger:a5,rightx:a3,righty:a4,start:b8,x:b2,y:b3,",
